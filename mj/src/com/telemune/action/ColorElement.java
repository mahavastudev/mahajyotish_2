...
public class ColorElement {
	...
	private static Logger logger = Logger.getLogger(ColorElement.class);
	...
	public Color lookupColor(String color) {
		logger.info("Inside lookupColor method of ColorElement action class.");
	...
	public BaseColor fillColor(String basecolor) {
		...
		logger.info("Inside fillColor method of ColorElement action class.");
