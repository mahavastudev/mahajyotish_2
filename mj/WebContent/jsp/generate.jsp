...
<div class="row col-sm-12">
	...
	<div class="col-sm-8" id="formDiv">
		<form class="form-horizontal" id="frm_demo" name="frm_demo"
			action='<c:url value="submitKundliDetails.action"/>'
				...
				<div class="col-sm-8">
					<table width="100%" height="100%">
						<tr>
							...
							<td width="10%" align="right" style="padding-left: 10px;"><a href='<c:url value="kundliLog.action"/>' data-ajax="false"><img
			...
			<s:if test='#session.containsKey("28")'>	
			<div class="form-group">
			...
			<s:if test='#session.containsKey("29")'>
			<div class="form-group">
