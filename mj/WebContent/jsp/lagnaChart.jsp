...
<s:if test='#session.containsKey("43")'>
...
$(document).ready(function(){
		...
		if(id==0){
			...
			$("#Pdf").hide();
			$("#downloadOption").show();
			console.log("show downlod option");
		}
		if(id==11){
			$("#vastuCircle").hide();
			$("#cuspalChart").hide();
		...
		if(isCircleClockWise=="43")
			image.src = "vastuImages/Chakra_anticlockwise.jpg";
		else
			image.src = "vastuImages/Chakra_clockwise.jpg";
		console.log('here ---------- ')
		...
		image.onload = function() {
			...
			var clientName="Planet Hits on Planets and Boxes (Life Contexts)";
			context.font = "16px sans-serif";
			context.fillText(clientName,300,50);
			context.restore();
...
<div id="downloadOption" class="row" style="margin-top: 150px; text-align: center">
	<div class="col-sm-12">
		<h4>Download your horoscope from menu options.</h4>
	</div>
</div>
