	...
	<div class="col-sm-8  col-xs-12">
		<div class="col-sm-12" id="innerHeadingDiv">
			<div class="container-fluid"
				...
				<div class="row-fluid">
					<div class="span8">
						<p class="header" align="center">Saved Kundli Details</p>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="table-responsive">
				<table id="dataTable" class="ui-table ui-responsive" width="100%" height="100%" align="center">
					<tr>
						...
						<th style="width:15%;">TOB</th>
						<th style="width:22%;">REMARKS</th>
						<s:if test='#session.containsKey("27")'>
							<th style="width:20%;">OCCUPATION</th>
						</s:if>
						<th style="width:10%;">VIEW</th>
						<th style="width:10%;">DELETE</th>
					</tr>
					<s:iterator value="kundliLogsLst">
						<tr>
							<td><s:property value="name" /></td>
							<td><s:property value="dob" /></td>
							<td><s:property value="tob" /></td>
							<td><s:property value="remarks"/></td>
							<s:if test='#session.containsKey("27")'>
								<td><s:property value="occupation"/></td>
							</s:if>
							<td>
								<a href='<c:url value="generateOldKundli.action?generateKundli.requestId=${requestId}&kundliType=Saved"/>'
								class="tableDataLink" data-ajax="false">View</a>
							</td>
							<td>
							<a href='<c:url value="deleteOldKundli.action?generateKundli.requestId=${requestId}"/>'
