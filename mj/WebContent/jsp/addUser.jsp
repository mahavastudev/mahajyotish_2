...
function validate()
{
    ...
    if(name=="")
    {
        ...
        $("#openAlert").click();
        document.frm_demo.password.focus();
        return false;
    }
	...
	<div class="col-sm-8">
		<div class="col-sm-12" id="innerHeadingDiv">
			<div class="container-fluid"
				...
				<div class="row-fluid">
					<div class="span8">
						<p class="header" align="center">User Management Add</p>
					</div>
				</div>
			</div>
		</div>
...
<div class="row col-sm-12">
	...
	<div class="col-sm-8" id="formDiv">
		<form class="form-horizontal" id="frm_demo" name="frm_demo"
			action='<c:url value="addUserExec.action"/>' method="post"
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="name"
						name="userInfo.uname" maxlength="40"/>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="password" class="form-control" id="password"
						name="userInfo.upassword" maxlength="40" onkeypress="return RestrictSpace()"/>
				</div>
			</div>
			<div class="form-group">
				<label for="email" class="col-sm-3 control-label">Email :</label>
				<div class="col-sm-8">
					<input type="text" class="form-control" id="email" name="userInfo.email" maxlength="50" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="mobileNo"
						name="userInfo.mobileNo" onkeydown="return onlyNumbers(event)" />
				</div>
			</div>
...
<!-- updated by gaurav Sharma  23rd Sept 2020, adding mv code from weeeeeeeeeeeeeeeeeeeeeeeeeb while adding user-->
			<div class="form-group">
                                <label for="prefix" class="col-sm-3 control-label">MV Code :</label>
                                <div class="col-sm-8">
                                        <input type="text" class="form-control" id="prefix"
                                                name="userInfo.ccCode" />
                                </div>
                        </div>
			<div class="form-group">
